...
export default function DealersList() {
  ...
  const filtered = useMemo(() => {
    ...
    return dealers.filter((dealer) => {
      ...
      const dealerArea = dealer.area?.toLowerCase() || "";

      if (
        searchQuery &&
        !dealerName.includes(searchQuery) &&
        !dealerArea.includes(searchQuery)
      ) {
        return false;
      }
  ...
  return (
    <>
      <SEO
        ...
        description="Find trusted building material dealers in Deoghar. Compare ratings, delivery and verified suppliers."
        path="/dealers"
      />
      ...
      <section className="relative overflow-hidden bg-[#0A192F]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-10">
          ...
          >
            Trusted Building{" "}
            <span className="text-[#FF6B00]">Material Dealers</span>
          </h1>

          <p className="mt-8 max-w-2xl text-lg leading-9 text-slate-300">
            Compare verified dealers, customer ratings, delivery availability
            and contact suppliers directly from SahiRate.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 py-8 lg:px-10">
          <div className="grid gap-4 lg:grid-cols-[1fr_auto_auto]">
            ...
            <button
              ...
              className={`h-14 rounded-xl border px-6 transition ${
                verifiedOnly
          ...
          {loading ? (
            ...
            <div className="rounded-3xl border border-slate-200 bg-white px-10 py-20 text-center">
              ...
              <p className="mx-auto mt-4 max-w-lg leading-8 text-slate-500">
                We couldn't find any dealer matching your current search or
                filters. Try changing the search keyword or disabling one of
                the filters.
              </p>
            </div>
          ) : (
                ...
                >
                  <div className="p-8">
                    <div className="flex items-start justify-between">
                      ...
                      <ArrowRight className="text-[#FF6B00] transition group-hover:translate-x-1" />
                    </div>
