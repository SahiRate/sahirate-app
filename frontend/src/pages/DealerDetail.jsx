...
export default function DealerDetail() {
  ...
  return (
    <>
      <SEO
        title={`${d.name} | Building Material Dealer in Deoghar | SahiRate`}
        description={`${d.name} is a building material dealer in ${
          d.area || "Deoghar"
        }. Check available materials, current prices, contact details and dealer information on SahiRate.`}
        keywords={`${d.name}, ${d.name} Deoghar, building material dealer Deoghar, construction material dealer Deoghar, cement dealer Deoghar, TMT dealer Deoghar, ${
          d.area || "Deoghar"
        } building material dealer, SahiRate`}
        path={`/dealers/${id}`}
      />
        ...
        <div className="grid md:grid-cols-[2fr_1fr] gap-8 mb-10">
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-4 text-sm">
              ...
              <span className="text-slate-500">
                · {d.years_in_business} years in business
              </span>
            </div>
